      ...
      <main>
        ...
        <section className='px-6 py-12'>
          <div className='grid w-full h-full grid-cols-2  md:grid-cols-3 lg:grid-col-4 xl:grid-col-6 gap-12'>
            <Link href="/playground/neumorphism" className={`w-full h-full text-5xl md:text-2xl px-2 py-8 flex flex-col rounded-xl display-container ${randomBoxShape()}`}>
            ...
            <Link href="/playground/submission" className={`w-full h-full text-5xl md:text-2xl px-2 py-8 flex flex-col rounded-xl display-container ${randomBoxShape()}`}>
            ...
            <Link href="/playground/horse-hopping" className={`w-full h-full text-5xl md:text-2xl px-2 py-8 flex flex-col rounded-xl display-container ${randomBoxShape()}`}>
            ...
            <Link href="/playground/fen-generator" className={`w-full h-full text-5xl md:text-2xl px-2 py-8 flex flex-col rounded-xl display-container ${randomBoxShape()}`}>
            ...
            <Link href="/playground/speed-reader" className={`w-full h-full text-5xl md:text-2xl px-2 py-8 flex flex-col rounded-xl display-container ${randomBoxShape()}`}>
